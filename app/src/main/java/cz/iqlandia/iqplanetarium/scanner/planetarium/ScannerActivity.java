    ...
    private void updateSeats() {
        runOnUiThread(() -> event.seatmap.forEach((row, seat) -> {
            ...
            seat.forEach((id, state) -> {
                ...
                switch (state) {
                    case EMTPY:
                        img.setColorFilter(ContextCompat.getColor(this, R.color.ok_fg), android.graphics.PorterDuff.Mode.SRC_IN);
                        break;
                    case OCCUPIED:
                        img.setColorFilter(ContextCompat.getColor(this, R.color.err_fg), android.graphics.PorterDuff.Mode.SRC_IN);
                        break;
                    case ENTRY_ALLOWED:
                        img.setColorFilter(ContextCompat.getColor(this, R.color.warn_fg), android.graphics.PorterDuff.Mode.SRC_IN);
                        break;
                    case POSSIBLE_DUPLICATE:
                        img.setColorFilter(ContextCompat.getColor(this, R.color.duplicate_fg), android.graphics.PorterDuff.Mode.SRC_IN);
                        break;
                }
            });
        }));
    ...
    private ImageView getSeat(Row row, Integer column) {
        switch (row) {
            case R1:
                switch (column) {
                    case 1:
                        return findViewById(R.id.a1);
                    case 2:
                        return findViewById(R.id.a2);
                    case 3:
                        return findViewById(R.id.a3);
                    case 4:
                        return findViewById(R.id.a4);
                    case 5:
                        return findViewById(R.id.a5);
                    case 6:
                        return findViewById(R.id.a6);
                    case 7:
                        return findViewById(R.id.a7);
                    default:
                        return findViewById(R.id.a8);
                }
            case R2:
                switch (column) {
                    case 1:
                        return findViewById(R.id.b1);
                    case 2:
                        return findViewById(R.id.b2);
                    case 3:
                        return findViewById(R.id.b3);
                    case 4:
                        return findViewById(R.id.b4);
                    case 5:
                        return findViewById(R.id.b5);
                    case 6:
                        return findViewById(R.id.b6);
                    case 7:
                        return findViewById(R.id.b7);
                    case 8:
                        return findViewById(R.id.b8);
                    case 9:
                        return findViewById(R.id.b9);
                    case 10:
            ...
            case R3:
                switch (column) {
                    case 1:
                        return findViewById(R.id.c1);
                    case 2:
                        return findViewById(R.id.c2);
                    case 3:
                        return findViewById(R.id.c3);
                    case 4:
                        return findViewById(R.id.c4);
                    case 5:
                        return findViewById(R.id.c5);
                    case 6:
                        return findViewById(R.id.c6);
                    case 7:
                        return findViewById(R.id.c7);
                    case 8:
                        return findViewById(R.id.c8);
                    case 9:
                        return findViewById(R.id.c9);
                    case 10:
                        return findViewById(R.id.c10);
                    case 11:
                        return findViewById(R.id.c11);
                    default:
                        return findViewById(R.id.c12);
                }
            case R4:
                switch (column) {
                    case 1:
                    ...
                    case 6:
                        return findViewById(R.id.d6);
                    case 7:
                        return findViewById(R.id.d7);
                    case 8:
                        return findViewById(R.id.d8);
                    case 9:
                        return findViewById(R.id.d9);
                    case 10:
                        return findViewById(R.id.d10);
                    default:
                        return findViewById(R.id.d11);
                }
            case R5:
                switch (column) {
                    case 1:
                    ...
                    case 2:
                        return findViewById(R.id.e2);
                    case 3:
                        return findViewById(R.id.e3);
                    case 4:
                        return findViewById(R.id.e4);
                    case 5:
